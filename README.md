Simulate the thermal properties of Heisenberg models on the maple-lead lattice usign iPEPS method. The implementation makes use of the U(1) symmetry using the iTensor library.
